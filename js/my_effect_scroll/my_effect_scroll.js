...
$(document).ready(function() {
    ...
    time3=0.6;
    $(".aboutHome .contenBox > div").each(function(){
    ...
    setlazy($(".aboutHome .titleBox, .titleAb, .contentAb .des > p, .sliderNewsPage .colItem .item "),'fadeInUp','0.4');
    setlazy($(".albumtHome .albumInfo .colItem:nth-child(1)"),'fadeInLeft','0.3');
    setlazy($(".albumtHome .albumInfo .colItem:nth-child(2)"),'fadeInRight','0.3');
    time6=0.3;
